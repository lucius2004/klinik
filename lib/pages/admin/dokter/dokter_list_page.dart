// lib/pages/admin/dokter/dokter_list_page.dart
...
class _DokterListPageState extends State<DokterListPage> with TickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    ...
    List<DokterModel> filteredList = dokterProvider.activeDokterList;

    if (_searchQuery.isNotEmpty) {
      filteredList = dokterProvider.searchDokter(_searchQuery);
    }
    if (_filterSpesialisasi != 'Semua') {
      filteredList = filteredList.where((d) => d.spesialisasi == _filterSpesialisasi).toList();
    }
    if (_filterGender != 'Semua') {
      filteredList = filteredList.where((d) => d.jenisKelamin == _filterGender).toList();
    }

    final statistics = dokterProvider.getStatistics();
    ...
    return Scaffold(
      ...
      body: SafeArea(
        child: Column(
          children: [
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: IconButton(
                      ...
                      color: const Color(0xFF475569),
                      onPressed: () => _showFilterDialog(context, dokterProvider),
                    ),
                  ),
                ],
              ),
              ...
              child: Container(
                ...
                child: TextField(
                  ...
                  decoration: InputDecoration(
                    hintText: 'Cari nama, NIP, spesialisasi...',
            ...
            // Filter Chips
            if (_filterSpesialisasi != 'Semua' || _filterGender != 'Semua')
              Padding(
                  ...
                  children: [
                    if (_filterSpesialisasi != 'Semua')
                      Chip(
                        ...
                        onDeleted: () => setState(() => _filterSpesialisasi = 'Semua'),
                      ),
                    if (_filterGender != 'Semua')
                      Chip(
                ...
                child: filteredList.isEmpty
                    ...
                    : ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          final dokter = filteredList[index];
                          return TweenAnimationBuilder<double>(
                            ...
                            child: _buildDokterCard(context, dokter, dokterProvider),
                          );
                        },
                      ),
              ),
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () {
          Navigator.push(context, MaterialPageRoute(builder: (context) => const DokterFormPage()));
        },
    ...
    return Center(
      child: Column(
        ...
        children: [
          ...
          const Text('Tidak ada data dokter', style: TextStyle(fontSize: 16, fontWeight: FontWeight.w600, color: Color(0xFF475569))),
          const SizedBox(height: 8),
          const Text('Tambahkan dokter baru untuk memulai', style: TextStyle(fontSize: 13, color: Color(0xFF94A3B8))),
        ],
      ),
    );
  }

  Widget _buildDokterCard(BuildContext context, DokterModel dokter, DokterProvider provider) {
    ...
    return Container(
      ...
      child: Material(
        ...
        child: InkWell(
          onTap: () {
            Navigator.push(context, MaterialPageRoute(builder: (context) => DokterDetailPage(dokterId: dokter.id)));
          },
          borderRadius: BorderRadius.circular(16),
          child: Padding(
              ...
              children: [
                ...
                Expanded(
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      Text(dokter.nama, style: const TextStyle(fontSize: 15, fontWeight: FontWeight.w700, color: Color(0xFF0F172A), letterSpacing: -0.3)),
                      ...
                      Row(
                        children: [
                          Container(
                            ...
                            child: Row(
                              children: [
                                const Icon(Icons.medical_services, size: 12, color: Color(0xFF0EA5E9)),
                                const SizedBox(width: 4),
                                Text(dokter.spesialisasi, style: const TextStyle(fontSize: 11, color: Color(0xFF0EA5E9), fontWeight: FontWeight.w600)),
                              ],
                            ),
                          ),
                        ],
                      ...
                      Row(
                        children: [
                          ...
                          const SizedBox(width: 4),
                          Text('NIP: ${dokter.nip}', style: const TextStyle(fontSize: 12, color: Color(0xFF64748B), fontWeight: FontWeight.w500)),
                          ...
                          Container(
                            ...
                            child: Text(currencyFormat.format(dokter.tarif), style: const TextStyle(fontSize: 11, fontWeight: FontWeight.w700, color: Color(0xFF10B981))),
                          ),
                        ],
                      ),
                    ],
                  ...
                  child: PopupMenuButton(
                    ...
                    onSelected: (value) {
                      if (value == 'detail') {
                        ...
                        Navigator.push(context, MaterialPageRoute(builder: (context) => DokterFormPage(dokter: dokter)));
                      } else if (value == 'delete') {
                        _showDeleteDialog(context, dokter, provider);
                      }
                    },
                  ),
                ),
  ...
  void _showFilterDialog(BuildContext context, DokterProvider provider) {
    final spesialisasiList = ['Semua', ...provider.getSpesialisasiList()];
    showDialog(
      context: context,
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              const Text('Spesialisasi', style: TextStyle(fontWeight: FontWeight.w600, fontSize: 14, color: Color(0xFF475569))),
              const SizedBox(height: 8),
              DropdownButtonFormField<String>(
                value: _filterSpesialisasi,
                decoration: InputDecoration(
                ...
                items: spesialisasiList.map((s) => DropdownMenuItem(value: s, child: Text(s))).toList(),
                onChanged: (value) => setState(() => _filterSpesialisasi = value!),
              ),
              const SizedBox(height: 16),
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Text('Apakah Anda yakin ingin menghapus data ${dokter.nama}?', style: const TextStyle(fontSize: 14, color: Color(0xFF64748B)), textAlign: TextAlign.center),
              const SizedBox(height: 24),
              Row(
                children: [
                  Expanded(
                      ...
                      onPressed: () async {
                        ...
                        if (context.mounted) {
                          ...
                          ScaffoldMessenger.of(context).showSnackBar(
                            SnackBar(
                              content: Text(success ? 'Data dokter berhasil dihapus' : 'Gagal menghapus data'),
